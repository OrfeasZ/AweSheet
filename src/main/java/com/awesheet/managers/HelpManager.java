...
public class HelpManager {
    ...
    public void initHelpArticles() {
        ...
        articles.put(6, new HelpArticle(6, "Editing a Cell",
                "To edit a cell you can double click on it, select it and start typing, or select it and type on the text box present in the top toolbar.\n" +
                "After you've finished your entry you can confirm the input by hitting ENTER (or the \"check\" button in the top toolbar), or revert to the prevous value by hitting ESC (or the \"cancel\" button in the top toolbar)."));
